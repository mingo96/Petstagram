...
class PetstagramNotificationsService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val notification =
            NotificationCompat.Builder(this, "petstagram_notifications")
                .setContentTitle("Notificaciones de Petstagram")
                .setContentText("Estamos esperando que alguien te vea")
